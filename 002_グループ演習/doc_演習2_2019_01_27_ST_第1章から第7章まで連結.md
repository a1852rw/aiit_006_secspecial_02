...
紅電カード発行端末とべ紅電ICカード読み取り機との通信は無線LANにより行われる。紅電ICカード発行機には認証情報が暗号化され保存されており、紅電ICカードをカード読み取り機にかざした際に紅電ICカード読み取り機と通信を行い紅電ICカードの認証を行う。
なお、紅電ICカード発行機や紅電ICカード読取機のセキュリティはこのSTの範囲ではない。  
